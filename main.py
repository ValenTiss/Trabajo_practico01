...
selector = input("Ingrese el algoritmo de ordenamiento que quiere usar (1) o (2)")
#Si los datos introducidos por el usuario son los esperados
if isinstance(dimension_ventana,int) and dimension_ventana % 2 == 1 and ("1" == selector or selector == "2"):
